...
public class CleanJobResourcesOperation implements OperationVisitor {
    @Override
    public void visit(AthenaComputeElement element) {
        System.out.println("clean job resources called for athena");
    }

    @Override
    public void visit(RedshiftComputeElement element) {
        System.out.println("clean job resources called for redshift");
    }
}
